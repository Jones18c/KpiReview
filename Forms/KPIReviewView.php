...
if (!isset($_SESSION['username'])) {
    ...
    if (!isset($_SERVER['HTTP_X_REQUESTED_WITH']) || strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) != 'xmlhttprequest') {
        ...
        <head>
            <meta charset="utf-8">
            <title>Access Denied - KPI Review</title>
...
if (!$isAjax) {
    ...
    <head>
        ...
        <title>KPI Review Details</title>
        <link rel="stylesheet" href="/node_modules/bootstrap/dist/css/bootstrap.css">
...
if ($result && $result->num_rows > 0) {
    ...
    echo '<h3 class="border-bottom mt-4"> <span class="bi bi-graph-up" style="vertical-align: middle;"> KPI Review - LOC #' . htmlspecialchars($row['location_number']) . '</h3>';
