...
<?php
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        if ($action == 'publish') {
            echo '<div class="m-4"><h3>Thank you for publishing your Manager KPI Review!</h3><br>';
            ...
            echo '<h4>Your Manager KPI Review has been saved as a draft. You can continue editing it later.</h4><br>';
        }
        ...
        if ($mailClassExists && $mimeClassExists && $netSMTPExists) {
            ...
            // Build email message
        $messageOut = "<h3>Manager KPI Review Submission</h3>";
        ...
        $headers['Subject'] = "[Manager KPI Review] " . $_POST['month'] . " " . $_POST['year'] . " Manager KPI Review for " . $_POST['locationName'] . " Published!";
        ...
        */
        ...
        $mail = $mail_object->send($outEmails, $headers, $body);
            ...
            if (PEAR::isError($mail)) {
                ...
                error_log("KPI Review email error: " . $emailError);
            } else {
                $emailSent = true;
            ...
            */
            ...
            if ($mailResult) {
                ...
                error_log("KPI Review: Both PEAR Mail and PHP mail() failed");
                error_log("KPI Review Debug Info: " . implode(" | ", $debugInfo));
            }
            ...
            error_log("KPI Review email exception: " . $e->getMessage() . " in " . $e->getFile() . ":" . $e->getLine());
        }
        } // End if ($sendEmail)
        ...
        if ($sendEmail) {
            ...
            if ($emailSent) {
                ...
                if ($emailError) {
                    error_log("KPI Review email error details: " . $emailError);
                }
            }
